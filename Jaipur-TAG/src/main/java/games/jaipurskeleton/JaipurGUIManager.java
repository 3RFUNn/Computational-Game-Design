// file: src/main/java/games/jaipurskeleton/JaipurGUIManager.java
 ...
 * These JComponents should then be added to the `parent` object received in the class constructor.</p>
 *
